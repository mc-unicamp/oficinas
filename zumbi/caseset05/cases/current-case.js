...
<dcc-trigger action="knot/>/navigate" label="Iniciar Fase 1"></dcc-trigger>
...
<p>O paciente diz que {estava planejando assustar umas pessoas}/_/ e resolveu {se esconder dentro de um barril na sua casa}/_/. Então, acabou sentando em cima de {um bicho que fazia um barulho esquisito com o rabo}/+/. O paciente {sente pouca dor}/_/, e {o local da picada tem pouco inchaço}/_/. O paciente também está com o {olho caído}/+/, tem {dificuldade para engolir}/+/ e está {cansado para respirar}/+/. A ferida {não apresenta nenhuma característica marcante}/_/. Além disso, seus {batimentos cardíacos estão normais}/_/.</p>
...
<p>O paciente relata que {estava atrasado para ir para escola Zumbi para aprender a domesticar zumboscas}/_/ - moscas que foram para Zumbilândia depois de comerem comida estragada. Então, {ele colocou o sapato correndo}/_/ e sentiu uma dor no dedão do pé. Nesse momento, {percebeu que esmagou alguma coisa}/+/, mas não deu muita importância. {Ao correr, o paciente começou a sentir uma dor muito forte no pé}/+/ e percebeu que estava com uma ferida no dedão. O local do ferimento {apresenta inchaço}/+/, e {a ferida é grande, com bordas elevadas e tem uma área preta no meio}/+/. Ao examinar o paciente, {você não descobre nada anormal}/_/. Seus {batimentos cardíacos estão normais}/_/.</p>
...
<p>O paciente conta que estava {coletando sucata para fazer um brinquedo novo}/_/, e {viu um bicho esquisito}/_/. Quando ele chegou perto do bicho, {levou uma ferroada na mão que doeu tanto}/+/ que ele pulou igual um macaco. Ele diz ainda que a {sua galinha de estimação correu para ajudar}/+/, e o bicho esquisito saiu correndo de medo. Ao chegar na clínica, o paciente {sente muita dor}/+/, e {o local da picada tem pouco inchaço}/_/. Ao examinar o paciente, você percebe que {ele está cansado para respirar}/+/. A ferida {não apresenta nenhuma característica marcante}/_/, mas seus {batimentos cardíacos estão descompassados, num ritmo atrapalhado}/+/.</p>
...
<p>O paciente relata que {foi passear de barco}/_/ e {parou numa ilha que tinha um farol muito bonito}/_/. Quando ele desceu do barco, {percebeu que a ilha tinha um monte de Zumbirinhas}/_/, um tipo de gaivota da Zumbilândia. Como está sempre com fome, o paciente {foi pegar um ovo para fazer uma boquinha}/_/, mas {sentiu uma dor muito forte na mão}/+/. Ao chegar na clínica, o paciente está com {muita dor no local da mordida}/+/, que também está {muito inchado}/+/ e {mudando para uma coloração azul}/+/. Ao examinar o paciente, {você não descobre nada anormal}/_/. Seus {batimentos cardíacos estão normais}/_/. Entretanto, {a ferida é grande, com bordas elevadas e tem uma área preta no meio}/+/.</p>
...
<p>O paciente relata que {foi pescar na mata}/_/. Logo antes de chegar no rio, viu {um bicho se que fazia um barulho engraçadinho com o rabo}/+/. Então, o paciente saiu atrás do bicho e, {quando se abaixou para encostar nele}/_/, o animal pulou e lhe {deu uma mordida}/+/ no braço. {olho caído}/+/, tem {dificuldade para engolir}/+/ e está {cansado para respirar}/+/. A ferida {não apresenta nenhuma característica marcante}/_/. Além disso, seus {batimentos cardíacos estão normais}/_/.</p>
