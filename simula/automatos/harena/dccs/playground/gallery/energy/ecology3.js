...
<rule-dcc-cell-pair id="carnivore-dies" label="carnivore dies" probability="0" transition="cc>__">
   ___
   _*_
   ___
</rule-dcc-cell-pair>
...
<div style="flex:48px; max-height:48px; display:flex; flex-direction:row">
   ...
   <img src="images/cell/carnivorous-dinosaur.svg" style="flex:10%; max-width:48px; max-height:48px">
   <div style="flex:50%; max-height:48px; margin-right:10px">
      <dcc-slider variable="carnivore_replicates" value="0" index></dcc-slider>
   </div>
</div>
<div style="flex:48px; max-height:48px; display:flex; flex-direction:row">
   <div style="flex:20%; max-width:96px; max-height:48px">
   ...
   <div style="flex:50%; max-height:48px; margin-right:10px">
      <dcc-slider variable="carnivore_dies" value="0" index></dcc-slider>
   </div>
</div>
