...
<rule-dcc-cell-pair id="fall-vertical" label="fall vertical" probability="0" transition="._>_.">
___
___
_*_
</rule-dcc-cell-pair>
<rule-dcc-cell-pair id="fall-oblique" label="fall oblique" probability="0" transition="._>_.">
___
___
*_*
</rule-dcc-cell-pair>
<rule-dcc-cell-pair id="roll" label="roll" probability="0" transition="._>_.">
___
*_*
___
</rule-dcc-cell-pair>
...
<div style="flex:48px; max-height:48px; display:flex; flex-direction:row">
   ...
   <div style="flex:50%; max-height:48px; margin-right:10px">
      <dcc-slider variable="fall_vertical" value="0" index></dcc-slider>
   </div>
</div>
<div style="flex:48px; max-height:48px; display:flex; flex-direction:row">
   ...
   <div style="flex:50%; max-height:48px; margin-right:10px">
      <dcc-slider variable="fall_oblique" value="0" index></dcc-slider>
   </div>
</div>
<div style="flex:48px; max-height:48px; display:flex; flex-direction:row">
   ...
   <div style="flex:50%; max-height:48px; margin-right:10px">
      <dcc-slider variable="roll" value="0" index></dcc-slider>
   </div>
</div>
